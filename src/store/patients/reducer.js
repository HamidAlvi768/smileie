...
const patientsReducer = (state = INIT_STATE, action) => {
  switch (action.type) {
    ...
    case GET_IMPRESSIONS:
      return { ...state, impressionsLoading: true, impressionsError: null };
    case GET_IMPRESSIONS_SUCCESS:
      return { ...state, impressions: action.payload.data || [], impressionsLoading: false, impressionsError: null };
    case GET_IMPRESSIONS_FAIL:
      return { ...state, impressionsLoading: false, impressionsError: action.payload };

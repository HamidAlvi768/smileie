...
export const getPatients = (params = {}) => ({ type: GET_PATIENTS, payload: params });
export const getPatientsSuccess = (response) => ({ type: GET_PATIENTS_SUCCESS, payload: response });
...
export const getMonitoredPatients = (params = {}) => ({ type: GET_MONITORED_PATIENTS, payload: params });
export const getMonitoredPatientsSuccess = (response) => ({ type: GET_MONITORED_PATIENTS_SUCCESS, payload: response });
export const getNotMonitoredPatients = (params = {}) => ({ type: GET_NOT_MONITORED_PATIENTS, payload: params });
export const getNotMonitoredPatientsSuccess = (response) => ({ type: GET_NOT_MONITORED_PATIENTS_SUCCESS, payload: response });

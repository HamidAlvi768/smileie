...
const PatientDetail = () => {
  ...
  useEffect(() => {
    ...
    getPatientStatsAPI(id)
      .then((res) => {
        setPatientStats(res.data?.data || null);
                ...
                <CardBody>
                  <div className="mb-2 d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex flex-column">
                      <span>{patientStats?.aligner_type || patient.alignerType}</span>
                    </div>
                  </div>
                  <div className="mb-2 d-flex align-items-center justify-content-between">
                    <strong>Started:</strong>
                    <div className="d-flex flex-column align-items-end">
                      <span>{patientStats?.first_step_started_at || patient.started || "2024-01-01"}</span>
                    </div>
                  </div>
                  <div className="mb-2 d-flex align-items-center justify-content-between">
                    ...
                    <span>
                      {typeof patientStats?.app_activation !== 'undefined'
                        ...
                        : (patient.app_activation === 1 ? "Activated" : "Not Activated")}
                    </span>
                  </div>
                  <div className="mb-2 d-flex align-items-center justify-content-between">
                    <strong>Aligner #:</strong>
                    <div className="d-flex flex-column align-items-end">
                      <span>{`#${patientStats?.step_number || alignerModalData.currentAligner} of ${patientStats?.total_steps || alignerModalData.totalAligners}`}</span>
                      <Button
                        color="link"
                        size="sm"
                        className="p-0"
                  ...
                  <div className="mb-2 d-flex align-items-center justify-content-between">
                    ...
                    <span>{patientStats?.next_step_started_at || patient.nextScan}</span>
                  </div>
                </CardBody>
              </Collapse>
            </Card>

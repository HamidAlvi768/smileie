...
const PhotoUploadReminder = () => {
  ...
  document.title = "Photo Upload Reminder | Smileie";
    ...
    <React.Fragment>
              ...
              <Card>
                <CardBody>
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <h4 className="card-title mb-0">Photo Upload Reminders</h4>
                    <Button 
                      color="primary" 
                      onClick={toggleModal}
                      className="btn-sm"
      ...
      <Modal isOpen={modal} toggle={toggleModal} size="lg" centered>
        <ModalHeader toggle={toggleModal}>
          {editingNotification ? "Edit Reminder" : "Add New Photo Upload Reminder"}
        </ModalHeader>
          ...
          <ModalBody>
            ...
            <FormGroup>
              ...
              <Input
                ...
                onChange={handleInputChange}
                placeholder="Enter custom message for this reminder..."
              />
            </FormGroup>
          </ModalBody>
          <ModalFooter>
            ...
            <Button color="primary" type="submit">
              {editingNotification ? "Update" : "Create"} Reminder
            </Button>
          </ModalFooter>
        </Form>
      </Modal>

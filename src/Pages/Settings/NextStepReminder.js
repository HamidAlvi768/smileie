...
const NextStepReminder = () => {
  ...
  document.title = "Next Step Reminder | Smileie";
    ...
    <React.Fragment>
              ...
              <Card>
                <CardBody>
                  <div className="d-flex justify-content-between align-items-center mb-4">
                    <h4 className="card-title mb-0">Next Step Reminders</h4>
                    <Button 
                      color="primary" 
                      onClick={toggleModal}
                      className="btn-sm"
      ...
      <Modal isOpen={modal} toggle={toggleModal} size="lg" centered>
        <ModalHeader toggle={toggleModal}>
          {editingNotification ? "Edit Reminder" : "Add New Next Step Reminder"}
        </ModalHeader>
